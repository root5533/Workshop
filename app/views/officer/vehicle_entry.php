            ...
            <div id="id01" class="w3-modal">
                <div class="w3-modal-content">
                    ...
                    <div class="w3-container w3-padding-large">
                        <div class="w3-container w3-padding-large">
                            <div class="col-sm-3">
                                <ul style="list-style-type: none" class="w3-ul">
                                    ...
                                    <li>Date & Time<span style="float: right;"><b>:</b></span></li>
                                </ul>
                            </div>
                            <div class="col-sm-9">
                                <ul style="list-style-type: none" class="w3-ul">
                        ...
                        <form action="<?php echo $GLOBALS['base_url']; ?>/VehicleController/insertEntryRecord" method="post">
    ...
    <div class="w3-container w3-margin-bottom">
        <div class="w3-container w3-white w3-padding-large">
            <div class="row-content">
                <div class="w3-container w3-teal w3-margin-bottom"><h3>Record Vehicle Entry</h3></div>
                <div class="col-sm-12" style="padding-top: 10px;">
                    <form action=<?php echo $GLOBALS['base_url'] . "/VehicleController/checkVehicleEntry"; ?> method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label for="date">Entry Date & Time</label>
